// ==========================================
// FILE: ./constants/app_colors.dart
// ==========================================
...
class AppColors {
  ...
  // ===========================================================================
  // 8. THEME B: CLEAN PAPER (LIGHT MODE)
  // ===========================================================================
  // A crisp, professional light theme using Slate 100-300 range.
  
  static const Color lightBackground = Color(0xFFF1F5F9); // Slate 100
  static const Color lightSurface = Color(0xFFFFFFFF);    // Pure White
  static const Color lightSurfaceContrast = Color(0xFFE2E8F0); // Slate 200
  ...
  // Gradients for Light
  static const LinearGradient lightElectricGradient = LinearGradient(
    colors: [primaryBlue, Color(0xFF82B1FF)], 
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  // ===========================================================================
  // 9. THEME C: SHARP OLED (HIGH CONTRAST)
  // ===========================================================================
  // Strict Pure Black/White for max visibility and battery saving.
  
  static const Color contrastBackground = Color(0xFF000000); // Pure Black
  static const Color contrastSurface = Color(0xFF000000);    // Pure Black
  static const Color contrastSurfaceContrast = Color(0xFF121212); // Off Black
  static const Color contrastBorder = Color(0xFFFFFFFF);     // Pure White (Mandatory)
  static const Color contrastHighVisYellow = Color(0xFFFFD600); // Accessibility Highlight
  
  // Text on Contrast
  static const Color contrastTextPrimary = Color(0xFFFFFFFF); // Pure White
  static const Color contrastTextSecondary = Color(0xFFE0E0E0);
